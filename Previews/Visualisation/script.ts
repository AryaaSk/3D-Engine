...
const localVisualisationScope = () => {
    ...
    document.onkeydown = ($e) => {
        ...
        else if ( key == "arrowleft" ) { cameraObject.position.x -= 50; player.position.x -= 50; }
        else if ( key == "arrowright" ) { cameraObject.position.x += 50; player.position.x += 50; }
    
        else if ( key == "w" ) { cameraObject.position.z += 50; player.position.z += 50; }
        else if ( key == "s" ) { cameraObject.position.z -= 50; player.position.z -= 50; }
