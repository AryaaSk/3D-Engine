...
var matrix = /** @class */ (function () {
    ...
    matrix.prototype.deleteColumn = function (columnIndex) { this.data.splice(columnIndex, 1); this.width -= 1; };
...
var Camera = /** @class */ (function () {
    ...
    Camera.prototype.enableMovementControls = function (canvasID, rotation, movement, zoom) {
        var _this = this;
        var mouseDown = false;
        var altDown = false;
        var previousX = 0;
        var previousY = 0;
        document.getElementById(canvasID).onmousedown = function ($e) { mouseDown = true; previousX = $e.clientX; previousY = $e.clientY; };
        document.getElementById(canvasID).onmouseup = function () { mouseDown = false; };
        document.getElementById(canvasID).onmousemove = function ($e) {
            ...
            if (altDown == true && movement == true) {
                ...
                _this.worldRotation.x -= differenceY / 5;
                _this.worldRotation.y -= differenceX / 5;
