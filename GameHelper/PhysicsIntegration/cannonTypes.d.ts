//Imported these from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/cannon/index.d.ts
//Just so that I can typescript auto-complete for cannonJS
